<?php
	//Downloading individual events(deleted) Registered students list 
	...
	if((isset($_SESSION["password"])))
	{
		...
		$j=0;
		$event_name='';
		$query = "SELECT event_name FROM `deleted_events` WHERE id = $id";
		...
		$t_price=0;
		$query1 = "SELECT sum(amount) FROM `deleted_registration` WHERE events='$event_name'";
		$result1 = mysqli_query($mysqli,$query1);
