<?php
	...
	{
		require 'sql_con.php';
		echo "<table border ='2' style='position:relative;left:110px;width:200px;top:220px;'>
				<tr>
				<th>Select Event</th>
				<th>Name</th>
				<th>Cost</th>
					...
					if (stristr($s, substr($name,0,$len)))
					{
						if($rc[$j]>0)
						{
							...
							<tr>
								...
								<div id='minmaxerror' style='position:absolute;top:300px;left:500px;font-size:18px;color:red;'></div>
								<td>$min[$j]</td>
								<td>$max[$j]</td>
							</tr>";
						}
