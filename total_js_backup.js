...
function home()//(admin.php , home.php)  
{	
...
function getdetails_iso(name)//(deleted_events.php , events_intermediate_iso.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function events() //(admin.php , events.php)
{
...
function receipts_home() //(admin.php , receiptbooks_detail.php)
{
	...
	var xmlhttp=new XMLHttpRequest();
  	...
  	xmlhttp.open("GET","receiptbooks_detail.php",true);
    xmlhttp.send();
}
...
function getdetails(name)// ((events.php)||(filled_events.php) , events_intermediate.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function delete_event(id)//(events_intermediate.php , delete_event.php)
{
...
function edit_event(name)//(events_intermediate.php , event_edit.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function search_events(st)//(all the event's files with a search box , event_search.php )
{
...
function filled_events()//(events.php ,filled_events.php) 
{
	document.getElementById("display").className = "eventdisp";
	document.getElementById("esearch").className = "esearch";
  ...
  xmlhttp.open("GET","filled_events.php",true);
  xmlhttp.send();
}

function excelevent_filled()//( filled_events.php , excel_allevents_filled.php)
{
var xmlhttp = new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function deleted_events()//(events.php , deleted_events.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
  	...
  	xmlhttp.open("GET","deleted_events.php",true);
    xmlhttp.send();
}


function excel_delevents()//(deleted_events.php , excel_delevents.php)
{
var xmlhttp = new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function book_id_fields()// ( add_receipt_book.php ,add_book_id_fields.php)
{
...
function all_book()//(receiptbooks_detail.php , receipt_book_details.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function pending_book()//(receiptbooks_detail.php , receipt_book_details.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function pending_to_delivered()//(receipt_book_details.php , pending_to_delivered.php)
{
var a = document.getElementsByName("pending");
var book_id = a[0].value;
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
    	if (xmlhttp.readyState==4 && xmlhttp.status==200)
...
function download_all()//(receipt_book_details.php , excel_receipt_book.php)
{
var n = 2;
var xmlhttp=new XMLHttpRequest();
xmlhttp.onreadystatechange=function()
...
function download_pending()//(receipt_book_details.php , excel_receipt_book.php)
{
	var n = 0;
	var xmlhttp=new XMLHttpRequest();
	xmlhttp.onreadystatechange=function()
...
function download_returned()//(receipt_book_details.php , excel_receipt_book.php)
{
var n = 1;
var xmlhttp=new XMLHttpRequest();
xmlhttp.onreadystatechange=function()
...
function addevent()//(events.php , NewEvent.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function selected_individual()//(NewEvent.php , choosen_individual.php)
{
	var xmlhttp = new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
  ...
  xmlhttp.open("GET","choosen_individual.php",true);
  xmlhttp.send();
}

function selected_club()//(NewEvent.php , choosen_club.php)
{
	var xmlhttp = new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
  ...
  xmlhttp.open("GET","choosen_club.php",true);
  xmlhttp.send();
}
...
function enter_club_event()//(making_new_club_1.php , adding_club.php)
{
	var n = document.getElementById("name").value; 
...
function make_new_club()//(choosen_club.php , making_newclub_1.php)
{
	...
	xmlhttp.open("GET","making_newclub_1.php",true);
	xmlhttp.send();
}
...
function search_approve_cash_receipts()
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
  	...
  	xmlhttp.open("GET","search_approve_cash_receipts.php",true);
    xmlhttp.send();
}
...
function receipt_details()//(event_reg.php , c_receipts_home.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
  	...
  	xmlhttp.open("GET","c_receipts_home.php",true);
    xmlhttp.send();
}

function mess_receipts()//(c_receipts_home.php , receipts_mess_button.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function cash_receipts()//(c_receipts_home.php , receipts_cash_button.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function excel_receipts_cash(s,e)
{
	var xmlhttp = new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
//approve
function Reciepts()//(receipts_cash_button.php , reciepts_display.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
  ...
  xmlhttp.open("GET","reciepts_display.php",true);
  xmlhttp.send();
}
...
function show_all_receipts_admin(s)
{
	...
	xmlhttp.open("GET","display_reciepts_admin.php",true);
    xmlhttp.send();
}
...
function change_pass()
{
	var xmlhttp=new XMLHttpRequest();
  	...
  	xmlhttp.open("GET","change_pass.php",true);
    xmlhttp.send();
}
function sub_pass()
{
...
function home_cash()//(c_home.php , coordinator_cash.php)
{
	var xmlhttp=new XMLHttpRequest();
  	...
  	xmlhttp.open("GET","coordinator_cash.php",true);
    xmlhttp.send();
}
function home_mess()//(c_home.php , coordinator_mess.php)
{
	var xmlhttp=new XMLHttpRequest();
  	...
  	xmlhttp.open("GET","coordinator_mess.php",true);
    xmlhttp.send();
}
...
//all receipts mess
function all_mess_receipts()//(receipts_mess_button.php , all_mess_receipts.php)
{
	var xmlhttp=new XMLHttpRequest();
  	xmlhttp.onreadystatechange=function()
  	{
...
function change_pass()
{
	var xmlhttp=new XMLHttpRequest();
  	...
  	xmlhttp.open("GET","change_pass_cord.php",true);
    xmlhttp.send();
}
function sub_pass()
{
...
function cash_home()
{
	var xmlhttp=new XMLHttpRequest();
  	...
  	xmlhttp.open("POST","ec_cash.php",true);
    xmlhttp.send();
}
function mess_home()
{
	var xmlhttp=new XMLHttpRequest();
  	...
  	xmlhttp.open("GET","ec_mess.php",true);
    xmlhttp.send();
}
function Cordinators()
{
	var xmlhttp=new XMLHttpRequest();
  	...
  	xmlhttp.open("POST","Event_cord_reciepts.php",true);
	xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    xmlhttp.send();
}
